...
export const SYMBOLS_VERSION = "20260914f";
...
export function errText(e) {
  const map = {
    ...
    content_declined:
      "לא נוכל ליצור סיפור על התוכן הזה. אפשר לנסח מחדש או לבחור מצב אחר — " +
      "למשל סיפור על בטיחות הגוף, על פרידה, או על מעבר בין מצבים.",
    ai_unavailable: "מנוע הסיפורים אינו זמין כרגע — נסו שוב בעוד רגע",
  };
